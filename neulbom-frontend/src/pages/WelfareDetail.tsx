  ...
  return (
    <div className="min-h-screen pb-20" style={{ backgroundColor: colors.lightGray }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {/* 원문 문서 보기 - source_link가 유효한 URL일 때만 표시 */}
        {welfare.source_link && welfare.source_link.trim() && welfare.source_link.startsWith('http') && (
          <Card variant="outlined" padding="md" className="mb-6">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() => {
                  if (welfare.source_link) {
                    window.open(welfare.source_link, '_blank', 'noopener,noreferrer');
                  }
                }}
              >
                문서 열기
